...
export const contractConfig: Record<SupportedChainId, ContractConfig> = {
  [megaEthTestnet.id]: {
    ...
    privacyRegistry: process.env.NEXT_PUBLIC_MEGAETH_PRIVACY_REGISTRY_ADDRESS as Address | undefined
  },
  [baseSepolia.id]: {
    ...
    privacyRegistry: process.env.NEXT_PUBLIC_BASE_SEPOLIA_PRIVACY_REGISTRY_ADDRESS as Address | undefined
  }
};
